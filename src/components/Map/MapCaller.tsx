...
//   useEffect(() => {
//     console.log('MapCaller render — currentUrl:', currentUrl, 'modalOpen:', modalOpen)
//   })

//   useEffect(() => {
//     console.log('[Effect] currentUrl changed:', currentUrl)
//     if (currentUrl === null && modalOpen) {
//       console.log('[Effect] Closing modal because currentUrl is null')
//       setModalOpen(false)
//     }
//   }, [currentUrl])

//   useEffect(() => {
//     console.log('[Effect] modalOpen changed:', modalOpen)
//   }, [modalOpen])
...
//     if (newState) {
//       console.log('[handleToggle] Opening modal and setting currentUrl')
//       setCurrentUrl('/map') // use any non-null string
//       setModalOpen(true)
//       setMobileNavOpen(false)
//     } else {
//       console.log('[handleToggle] Closing modal and resetting currentUrl')
//       setCurrentUrl(null)
//       setModalOpen(false)
//     }
//   }
...
//             modalOpen ? 'opacity-100 z-[60]' : 'opacity-0'
//           }`}
//         >
